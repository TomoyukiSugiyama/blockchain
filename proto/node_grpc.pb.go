...
type NodeClient interface {
	ResisterNode(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinReply, error)
}
...
func (c *nodeClient) ResisterNode(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinReply, error) {
...
type NodeServer interface {
	ResisterNode(context.Context, *JoinRequest) (*JoinReply, error)
...
func (UnimplementedNodeServer) ResisterNode(context.Context, *JoinRequest) (*JoinReply, error) {
...
func _Node_ResisterNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).ResisterNode(ctx, req.(*JoinRequest))
	}
